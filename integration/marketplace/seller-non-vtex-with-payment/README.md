...
In this model are integrated products (SKUs) commercial condition updating (price, inventory) of a SKU, besides the drop of an order, payment data (for Sellers PCI) and order dispatch authorization for the Seller.
